          ...
          <div className="image-wrapper">
            ...
            <div className="image-overlay">
              ...
              <div className="project-actions">
                {liveLink && (
                  <a href={liveLink} target="_blank" rel="noopener noreferrer" className="action-btn live">
                    View Live <span className="arrow">↗</span>
                  </a>
                )}
                {githubLink && (
                  <a href={githubLink} target="_blank" rel="noopener noreferrer" className="action-btn github" title="View Code">
          ...
          <div className="details-rows">
            ...
            <div className="project-stacks">
              {stacks.map((stackName) => {
                ...
                return (
                  <div key={stackName} className="stack-icon-wrapper" title={stackName}>
